...
import { HIGHLIGHTED_COUNTRIES } from "@/config/globalNetworkCountries";

const geoUrl = "https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json";

const highlightedCountries = HIGHLIGHTED_COUNTRIES;
    ...
    >
      ...
      >
        ...
        {arcDestinations.map((dest) => {
          const isTopArc =
            dest.name === "United States of America" || dest.name === "United Kingdom";
